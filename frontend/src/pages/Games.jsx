...
export default function Games() {
  ...
  const [loadingTopFavorites, setLoadingTopFavorites] = useState(false);
  ...
  const loadTopFavorites = async () => {
    ...
    try {
      const response = await gamesAPI.getTopFavoriteGames();
            ...
            {activeTab === 'top-favorites' ? (
              <div>
                <h2 className="text-xl font-semibold mb-6 text-white flex items-center gap-2">
                  <span className="text-2xl">⭐</span> Top 5 Jeux Favoris
                </h2>
                ...
                {loadingTopFavorites ? (
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {topFavorites.map((game, index) => (
                      <div
                        key={game.id}
                        className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-primary/20 hover:border-primary-light/40 transition-all shadow-lg hover:shadow-glow-red group relative"
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3">
                            <div>
                        ...
                        {userGameIds.has(game.id) ? (
                          <div className="flex items-center gap-2 text-green-400 text-sm bg-green-500/10 rounded px-2 py-1 justify-center border border-green-500/30 w-full">
                          ...
                          <button
                            ...
                            className="w-full px-4 py-2 bg-gradient-to-br from-green-600 to-green-500 text-white hover:shadow-lg hover:shadow-green-500/50 border border-green-400/30 rounded-lg text-sm transition-all transform hover:scale-105"
                          >
                            + Ajouter
                          </button>
                        )}
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-white">Pas de favoris trouvés</h3>
                  </div>
                )}
              </div>
            ) : (

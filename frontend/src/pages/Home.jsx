                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${
                          match.statut === 'actif' ? 'bg-green-500 text-black' 
                            : match.statut === 'inactif' ? 'bg-red-500 text-white'
                            : match.statut === 'premium' ? 'bg-yellow-400 text-black'
                            : 'bg-gray-600 text-white'
                        }`}>
                          {match.statut === 'actif' 
                            ? 'Actif' 
                            : match.statut === 'inactif'
                            ? 'Inactif'
                            : match.statut === 'premium'
                            ? 'Premium'
                            : 'Hors ligne'}
                        </span>
                      </div>
